...
import { CartEmpty } from '~/widgets/Cart/CartEmpty'
import { CartItem } from '~/widgets/Cart/CartItem'
import { clearItems } from '~/widgets/Cart/model/slice'

export const Cart: FC = () => {
  const dispatch = useAppDispatch()
  const { items: pizzas, totalPrice } = useAppSelector(state => state.cart)
